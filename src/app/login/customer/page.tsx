  ...
  return (
    <div className="min-h-screen bg-[#050915] text-slate-100 px-4 py-12">
      <div className="max-w-md mx-auto rounded-2xl border border-slate-700/70 bg-slate-900/80 p-6">
        <div className="text-xs uppercase tracking-wide text-cyan-300">PlantTrace Portal</div>
        <h1 className="mt-2 text-3xl font-semibold">Customer Login</h1>
        <p className="mt-2 text-sm text-slate-300">For plant teams and customer stakeholders.</p>

        <form className="mt-6 space-y-4">
          <label className="block">
            <span className="text-xs text-slate-400">Work Email</span>
            <input type="email" className="mt-1 w-full rounded-md border border-slate-700 bg-slate-950 px-3 py-2 text-sm" placeholder="you@company.com" />
          </label>
        ...
        <div className="mt-4 text-xs text-slate-400">Need access? Contact your PlantTrace admin.</div>
