    ...
    <div className="min-h-screen bg-[#050915] text-slate-100 px-4 py-12">
      <div className="max-w-md mx-auto rounded-2xl border border-slate-700/70 bg-slate-900/80 p-6">
        ...
        <p className="mt-2 text-sm text-slate-300">
          One login for customer and admin access. Your role determines what you see after sign-in.
        </p>
        ...
        <div className="mt-4 text-xs text-slate-400">Need access? Contact your PlantTrace administrator.</div>
